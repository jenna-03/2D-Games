...
private:
    ...
    // Flyer specific variables
    float m_flight_time = 0.0f;
    float m_vertical_amplitude = 1.0f;
...
public:
    ...
    void ai_fly(); // New method for flying enemies
    ...
    void move_left() { m_movement.x = -1.0f; face_left(); m_facing_left = true; }
    void move_right() { m_movement.x = 1.0f;  face_right(); m_facing_left = false; }
    ...
    bool      const is_facing_left() const { return m_facing_left; }
    float get_patrol_range() const { return m_patrol_range; }
    ...
    void const set_facing_left(bool facing_left) { m_facing_left = facing_left; }
    void set_patrol_range(float range) { m_patrol_range = range; }
    void set_patrol_point(glm::vec3 new_patrol_point) { m_patrol_point = new_patrol_point; }
    void const set_vertical_amplitude(float new_amplitude) { m_vertical_amplitude = new_amplitude; }
